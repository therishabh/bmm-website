    ...
    <div id="desktop-left-bar">
        <section id="left-pannel">
            <ul>
                ...
                <li>
                    <a href="salon-subscription.php" class="<?php echo strpos($_SERVER['REQUEST_URI'], 'salon-subscription') !== false ? 'active' : '' ?>">
                        <i class="fa fa-credit-card" aria-hidden="true"></i>
                        Salon Subscription
                    </a>
                </li>
                <li>
                    <a href="makeup-artist-subscription.php" class="<?php echo strpos($_SERVER['REQUEST_URI'], 'makeup-artist-subscription') !== false ? 'active' : '' ?>">
                        <i class="fa fa-credit-card" aria-hidden="true"></i>
