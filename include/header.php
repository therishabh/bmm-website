...
<html lang="en">
    ...
    <body>
        ...
        <nav>
            <div class="container-fluid">
                <ul>
                    <li><a onmouseover="javascript:nav.services('salon')">Salon</a>
                        <div class="submenu">
                    ...
                    <li><a onmouseover="javascript:nav.services('makeup-artist')">Makeup Artist </a>
                        <div class="submenu">
                            ...
                            <div class="">
                                <div class="row">
                                    ...
                                    <div class="col-md-9"  id="makeup_nav">
                    ...
                    <li><a onmouseover="javascript:nav.services('bridal-makeup')">Bridal Makeup</a>
                        <div class="submenu">
                            ...
                            <div class="">
                                <div class="row">
                                    ...
                                    <div class="col-md-9" id="bridal_nav">
                    ...
                    <li><a  onmouseover="javascript:nav.services('gents')">Men's</a>
                        <div class="submenu">

                            <div class="row">
                                <div class="col-md-9" id="gents_nav"> 
